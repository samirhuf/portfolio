...
m1.write('')
m2.metric('Total Gain Today: ', value=total_gain_today+' Lakhs')
m3.metric('Total Gain: ', value=total_gain+' Lakhs')
m4.metric('Current Investment: ', value=current_investment+' Lakhs')
m5.write('')
