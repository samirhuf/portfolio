...
m1.write('')
m2.metric('Total Gain Today: ', value=str(total_gain_today)+' Lakhs',border=True)
m3.metric('Total Gain: ', value=str(total_gain)+' Lakhs',border=True)
m4.metric('Current Investment: ', value=str(current_investment)+' Lakhs',border=True)
m5.write('')
